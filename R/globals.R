...
local.search.algorithms = c("mmpc", "si.hiton.pc", "gs.pc", "iapc", "fast.iapc", "inter.iapc", "fdr.iapc", "hpc", "hpc.cached")
...
method.labels = c(
  ...
  "hpc.cached" = "Hybrid Parents and Children (cached version)"
)
...
method.extra.args = list(
  ...
  'hpc.cached' = c("pc.method", "nbr.join")
)
